...
export const initMockStateJSON = {
...
export const store = createStore(reducers, initMockStateJSON, applyMiddleware(thunk))

/**
 *  We capture the api end point url passed in from envinment variables
 */
